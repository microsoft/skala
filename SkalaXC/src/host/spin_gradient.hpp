 ...
 * @param source Source gradient.
 * @param destination Writable destination point block.
 */
template <typename Channel>
 ...
 * @param source Source point block.
 * @param destination Pre-sized destination gradient.
 */
