...
| Traditional-functional parity | `skala_traditional_integration_test.cxx` | Public SkalaXC results against GauXC/ExchCXX for six molecules, three models, random UKS densities, and serial/MPI execution. |
...
| Public C++ consumer | CTest `skalaxc_public_api` | Installed-style header use, PIMPL isolation, owning outputs, state/error contracts, gradients, settings, batching, and diagnostics. |
