...
if(NOT gauxc_FOUND)
  ...
  if(${Skala_GauXC_ENABLE_OPENMP} AND NOT ${GAUXC_HAS_OPENMP})
    message(FATAL_ERROR "GauXC Found with OpenMP support but Skala_GauXC_ENABLE_OPENMP is OFF")
  endif()
  if(${Skala_GauXC_ENABLE_MPI} AND NOT ${GAUXC_HAS_MPI})
    message(FATAL_ERROR "GauXC Found with MPI support but Skala_GauXC_ENABLE_MPI is OFF")
  endif()
