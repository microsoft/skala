...
Example:
    >>> from skala_model.utils.irreps import Irrep, Irreps
    >>> Irrep("1o")
    1o
...
class Irrep:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if isinstance(other, tuple) and len(other) == 2:
            other_l, other_p = other
            assert isinstance(other_l, int)
            assert isinstance(other_p, int)
            return self._l == other_l and self._p == other_p
        return False
