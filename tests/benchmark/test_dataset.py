...
from skala.benchmark.dataset import (
    DATASET_DIR_ENV,
    dataset_path,
    default_dataset_dir,
...
from skala.benchmark.fetch import CONFORMER_SI_SHA256, SOURCES, atomic_numbers
...
def test_manifest_holds_no_coordinates() -> None:
    ...
    from skala.benchmark.dataset import MANIFEST_FILE

    text = (files("skala.benchmark") / MANIFEST_FILE).read_text(encoding="utf-8")
